  ...
  describe("resolveOffset", () => {
    ...
    it.effect("throws for negative port offset", () =>
      Effect.gen(function* () {
        ...
        assert.ok(error.includes("Invalid KAIRO_PORT_OFFSET"));
      }),
    );
  });

  describe("createDevRunnerEnv", () => {
    it.effect("defaults KAIRO_HOME to ~/.kairo when not provided", () =>
      Effect.gen(function* () {
        ...
        assert.equal(env.KAIRO_HOME, path.resolve(NodeOS.homedir(), ".kairo"));
      }),
    );
