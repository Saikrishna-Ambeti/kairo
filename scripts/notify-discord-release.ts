  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Kairo prerelease is available for nightly testers."
          : "A new Kairo latest release is available.",
...
).pipe(Command.withDescription("Post a Kairo release announcement to Discord."));
