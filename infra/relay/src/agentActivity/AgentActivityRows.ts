import type { RelayAgentActivityState } from "@kairo/contracts/relay";
import { RelayAgentActivityState as RelayAgentActivityStateSchema } from "@kairo/contracts/relay";
...
export class AgentActivityRows extends Context.Service<AgentActivityRows, AgentActivityRowsShape>()(
  "kairo-relay/agentActivity/AgentActivityRows",
) {}
