...
import type { RelayDeliveryResult } from "@kairo/contracts/relay";
...
>()("kairo-relay/agentActivity/ApnsDeliveryQueue/ApnsDeliveryQueueSender") {}
...
export class ApnsDeliveryQueue extends Context.Service<ApnsDeliveryQueue, ApnsDeliveryQueueShape>()(
  "kairo-relay/agentActivity/ApnsDeliveryQueue",
) {}
