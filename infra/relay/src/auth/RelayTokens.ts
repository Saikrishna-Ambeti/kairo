...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@kairo/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "kairo-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "kairo-relay-dpop-access+jwt";
