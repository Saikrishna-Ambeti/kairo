...
See the [Kairo Connect architecture note](../../docs/internals/kairo-connect.md) for the larger system
design.
...
- Linking Kairo environments to a cloud account.
...
```sh
vp run --filter kairo-relay deploy
```
...
vp run --filter kairo-relay deploy -- --env-file .env.local
```
...
- [Kairo Connect setup](../../docs/operations/connect-setup.md) for Clerk keys, JWT templates, and sign-up restrictions.
- [Relay Observability](../../docs/operations/relay-observability.md) for deployment tracing and diagnostics.
- [Kairo Connect architecture](../../docs/internals/kairo-connect.md) for environment linking and trust boundaries.
