...
1. Install the GitHub CLI on the machine running Kairo:
   ```bash
   brew install gh
   ```
2. Sign in:
...
2. Add these environment variables to the environment running Kairo:
   ```bash
   export KAIRO_BITBUCKET_EMAIL="you@example.com"
   export KAIRO_BITBUCKET_API_TOKEN="your-token"
   ```
3. Restart Kairo and verify the connection in **Source Control settings**
