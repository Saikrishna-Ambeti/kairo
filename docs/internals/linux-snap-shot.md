...
`<app-id>.SnapShot` on the session bus and exports `com.kairo.SnapShot.Capture`; the config
...
The extension trusts callers that own `com.kairo.Kairo.SnapShot` (or the `.Development`
