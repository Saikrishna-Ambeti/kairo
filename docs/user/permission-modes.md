...
Antigravity uses its own permission policy for each mode. Kairo still shows any approval or
...
Kairo's separate Plan mode control is not available for Antigravity. See
