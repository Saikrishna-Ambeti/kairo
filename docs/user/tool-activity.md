...
Recognized Kairo tools use descriptive labels in both the running summary and individual rows.
...
Preview browser actions use a globe icon. Other Kairo tools keep the Kairo mark.
