...
Kairo selects a project icon automatically. It checks `kairo.json`, common favicon and app icon
...
Kairo supports SVG, PNG, ICO, JPEG, GIF, AVIF, and WebP files. The selected path applies to
...
Kairo checks in the background and when the server starts. It uses the branch's configured
