...
Kairo through another app's system share sheet.
...
messages survive app restarts. Signing out of Kairo Connect keeps that work on your
...
Kairo remembers your provider, model, and model options for new threads. A
...
Provider commands must start the message to run. Kairo commands such as
...
automatically. HTML previews cannot access your Kairo session.
