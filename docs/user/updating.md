...
| Action                     | What to do                                                                                                                                                                |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Update server**          | Available for the Kairo Linux background service. Select the button and leave Kairo open while it prepares, tests, restarts, and reconnects.                              |
| **Update the desktop app** | Open the Kairo desktop app on the machine that runs the server and install the app update there. Reopen it if needed.                                                     |
