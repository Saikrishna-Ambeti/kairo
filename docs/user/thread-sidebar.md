...
When you change a new thread's project, Kairo stays in the current environment
...
If dragging is unavailable for one environment, update the Kairo server running in that
