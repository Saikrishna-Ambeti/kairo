...
- `kairo-relay-traces-prod`, an OpenTelemetry trace dataset for Worker requests
- `kairo-relay-otel-ingest-prod`, a dataset-scoped ingest token bound to the Worker
- `kairo-relay-recent-spans-prod`, a view of recent request and endpoint spans
