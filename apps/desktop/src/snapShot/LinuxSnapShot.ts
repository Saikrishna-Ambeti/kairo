...
const EXTENSION = "org.gnome.Shell.Extensions.KairoSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/KairoSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Kairo instance is capturing a window. Try again.");
    }
