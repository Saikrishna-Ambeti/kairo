import type { DesktopSshPasswordPromptRequest } from "@kairo/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@kairo/contracts";
import type { SshPasswordRequest } from "@kairo/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Kairo window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@kairo/desktop/ssh/DesktopSshPasswordPrompts") {}
