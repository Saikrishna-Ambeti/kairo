...
>()("@kairo/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__KAIRO_ENV_${name}_START__`;
const endMarker = (name: string) => `__KAIRO_ENV_${name}_END__`;
