...
function getGnomeKeyringRemediationMessage(): string {
  return "Kairo could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Kairo.";
}

function getKWalletRemediationMessage(): string {
  return "Kairo could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Kairo.";
}
