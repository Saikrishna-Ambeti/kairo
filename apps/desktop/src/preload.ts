...
// oxlint-disable-next-line kairo/no-global-process-runtime -- Electron exposes the client platform in its sandboxed preload process.
...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  playNotificationSound: (sound) =>
    ipcRenderer.invoke(IpcChannels.PLAY_NOTIFICATION_SOUND_CHANNEL, sound),
