...
} from "@kairo/shared/advertisedEndpoint";
import type {
  AdvertisedEndpoint,
...
import { readTailscaleStatus } from "@kairo/tailscale";
...
>()("@kairo/desktop/backend/DesktopServerExposure") {}
...
>()("@kairo/desktop/backend/DesktopServerExposure/DesktopNetworkInterfacesService") {}
