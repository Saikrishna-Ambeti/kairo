...
export const LinuxBrowserSecretPath = Context.Reference<string | undefined>(
  "@kairo/desktop/preview/BrowserImport/LinuxBrowserSecretPath",
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const relative = environment.path.join("browser-secret", "kairo-browser-secret");
