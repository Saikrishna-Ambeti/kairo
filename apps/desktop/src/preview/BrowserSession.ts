...
const PREVIEW_PARTITION_PREFIX = "persist:kairo-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "kairo-preview-ephemeral-";
...
>()("@kairo/desktop/preview/BrowserSession") {}
