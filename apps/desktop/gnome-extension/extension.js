...
const NAME = "org.gnome.Shell.Extensions.KairoSnapShot";
const PATH = "/org/gnome/Shell/Extensions/KairoSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Kairo capture preview unavailable: ${error.message}`);
    }
  }
...
export default class KairoSnapShotExtension extends Extension {
  enable() {
