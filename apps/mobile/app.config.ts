...
const isIosPersonalTeamBuild = repoEnv.KAIRO_IOS_PERSONAL_TEAM === "1";
const runtimeVersionPolicy =
  process.env.MOBILE_VERSION_POLICY ??
  (APP_VARIANT === "development" ? "appVersion" : "fingerprint");

const personalTeamBundleIdentifier = repoEnv.KAIRO_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "KAIRO_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.kairo when KAIRO_IOS_PERSONAL_TEAM=1.",
  );
}
...
const VARIANT_CONFIG = {
  development: {
    ...
    relyingParty: "clerk.kairo.codes",
...
const config: ExpoConfig = {
  ...
  updates: {
    enabled: repoEnv.KAIRO_MOBILE_UPDATES_ENABLED !== "0",
    url: "https://u.expo.dev/70158114-215e-4d36-95a6-295719cf8aa2",
  ...
  ios: {
    ...
    requireFullScreen: process.env.KAIRO_SHOWCASE_CAPTURE_BUILD === "1",
    bundleIdentifier: iosBundleIdentifier,
    // Pin code signing to the Kairo Tools team so non-interactive `expo run:ios`
    ...
    infoPlist: {
      ...
      NSPhotoLibraryAddUsageDescription: "Allow Kairo to save images to your photo library.",
      ...
      ...(process.env.KAIRO_SHOWCASE_CAPTURE_BUILD === "1"
        ? {
  ...
  android: {
    ...
    ...(repoEnv.KAIRO_ANDROID_GOOGLE_SERVICES_FILE
      ? { googleServicesFile: repoEnv.KAIRO_ANDROID_GOOGLE_SERVICES_FILE }
      : {}),
    adaptiveIcon: {
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Kairo to use your microphone for voice input.",
  ...
  extra: {
    ...
    eas: {
      projectId: "70158114-215e-4d36-95a6-295719cf8aa2",
    },
  },
  owner: "namratachoudhari",
};
