...
function RootStackLayout(props: {
  ...
  // Presents the Kairo Connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-kairo-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-kairo-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
