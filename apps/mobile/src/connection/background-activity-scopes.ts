import type { EnvironmentRpcSubscriptionObservation } from "@kairo/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@kairo/contracts";
