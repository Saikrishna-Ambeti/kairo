...
import { ConnectionTransientError } from "@kairo/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "kairo.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "kairo.connections";
