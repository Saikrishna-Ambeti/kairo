...
const ReviewNotice = memo(function ReviewNotice(props: { readonly notice: string }) {
  return (
    <View className="border-b border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-900/60 dark:bg-amber-950/40">
      <Text className="text-[12px] font-kairo-bold uppercase text-amber-700 dark:text-amber-300">
        Partial diff
      </Text>
  ...
  const content = (
    <>
      <SymbolView
        ...
        type="monochrome"
      />
      <Text className="text-[15px] font-kairo-bold text-white">{props.title}</Text>
    </>
  );
    ...
    if (error) {
      children.push(
        <View key="review-error" className="border-b border-border bg-card px-4 py-3">
          <Text className="text-[13px] font-kairo-bold text-foreground">Review unavailable</Text>
          ...
          >
            ...
            {!selectedSection ? (
              <View className="border-b border-border bg-card px-4 py-5">
                <Text className="text-[14px] font-kairo-bold text-foreground">No review diffs</Text>
              ...
              <View className="border-b border-border bg-card px-4 py-5">
                <Text className="text-[14px] font-kairo-bold text-foreground">No changes</Text>
                <Text className="text-[12px] leading-[18px] text-foreground-muted">
