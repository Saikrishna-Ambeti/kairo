...
import { reportAtomCommandResult, settlePromise } from "@kairo/client-runtime/state/runtime";
 ...
 * surfaces the account's Kairo Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your Kairo account to set up Kairo Connect.
            </Text>
          </View>
        )}
