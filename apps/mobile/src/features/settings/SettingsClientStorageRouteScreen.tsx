...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@kairo/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text className="font-kairo-medium tabular-nums text-danger-foreground" numberOfLines={1}>
