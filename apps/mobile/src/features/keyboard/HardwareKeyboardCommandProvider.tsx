...
import { KairoKeyboardCommands } from "../../native/KairoKeyboardCommands";
import {
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <KairoKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
      {children}
    </KairoKeyboardCommands>
  );
}
