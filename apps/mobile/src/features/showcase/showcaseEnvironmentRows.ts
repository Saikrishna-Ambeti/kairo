...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.kairo.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.kairo.sh",
  wsBaseUrl: "wss://pocket-pi.kairo.sh",
  providerKind: "kairo_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.kairo.sh",
    isRelayManaged: true,
