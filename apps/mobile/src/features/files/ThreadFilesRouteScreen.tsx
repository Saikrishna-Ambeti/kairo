...
} from "@kairo/shared/filePreview";
import { mediaFileReference } from "@kairo/client-runtime/media-reference";
    ...
    <View className="flex-1 bg-sheet">
      {props.truncated ? (
        <View className="border-b border-adaptive-amber-200-900-a60 bg-adaptive-amber-50-950-a40 px-4 py-2">
          <Text className="text-2xs font-kairo-bold uppercase text-adaptive-amber-700-300">
            Partial file
          </Text>
