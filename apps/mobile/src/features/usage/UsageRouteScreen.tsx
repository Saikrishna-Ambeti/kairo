import { EnvironmentId, USAGE_CONTRACT_VERSION } from "@kairo/contracts";
import { useNavigation } from "@react-navigation/native";
import {
  isCompatibleUsageContractVersion,
  type DailyTotals,
  type MergedUsage,
} from "@kairo/shared/usageMerge";
import {
  enumerateDays,
  enumerateHourStarts,
  formatCount,
          ...
          >
            <Text
              className={cn(
                ...
                active ? "font-kairo-medium text-foreground" : "text-foreground-muted",
              )}
            >
              {option.label}
            </Text>
