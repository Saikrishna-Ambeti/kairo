...
export function PendingUserInputCard(props: PendingUserInputCardProps) {
  ...
  const bar = showBar ? (
    ...
    >
      ...
      >
        <Text className="font-kairo-bold text-2xs uppercase tracking-[1.1px] text-adaptive-sky-700-300">
          User input needed
        </Text>
    ...
    >
      ...
      >
        <View className="flex-1 gap-2.5">
          ...
          <Text className="font-kairo-bold text-lg text-adaptive-neutral-950-50">
        ...
        {props.pendingUserInput.questions.map((question) => {
          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text className="font-kairo-bold text-xs uppercase tracking-[1px] text-neutral-500">
                {question.header}
              </Text>
