...
export function PendingUserInputCard(props: PendingUserInputCardProps) {
  ...
  const card = renderCard ? (
    ...
    >
        ...
        {props.pendingUserInput.questions.map((question) => {
          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text className="font-kairo-bold text-xs uppercase tracking-[1px] text-neutral-500 dark:text-neutral-500">
                {question.header}
              </Text>
      ...
      >
        <Text className="font-kairo-extrabold text-sm text-white">Submit answers</Text>
      </Pressable>
    </Animated.View>
  ) : null;
  return (
