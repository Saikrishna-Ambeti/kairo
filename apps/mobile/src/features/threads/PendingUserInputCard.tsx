...
import type { ApprovalRequestId, UserInputQuestion } from "@kairo/contracts";
...
export function PendingUserInputCard(props: PendingUserInputCardProps) {
  ...
  const bar = showBar ? (
    ...
    >
      ...
      >
        <Text className="font-kairo-bold text-2xs uppercase tracking-[1.1px] text-foreground-secondary">
          User input needed
        </Text>
    ...
    >
      ...
      >
        <View className="flex-1 gap-2.5">
          ...
          <Text className="font-kairo-bold text-lg text-foreground">Fill in the pending answers</Text>
        </View>
        ...
        {props.pendingUserInput.questions.map((question) => {
          ...
          return (
            <View key={question.id} className="gap-2 pt-1">
              <Text className="font-kairo-bold text-xs uppercase tracking-[1px] text-foreground-muted">
                {question.header}
              </Text>
      ...
      {props.pendingUserInput.dismissible ? (
        ...
        >
          <Text className="font-kairo-bold text-sm text-foreground-muted">
