    ...
    >
      ...
      {linkedPrChains.length > 0 ? (
        <View className="gap-2">
          <Text className="px-1 text-xs font-kairo-bold text-foreground-muted">
    ...
    >
      ...
      {isInspector ? (
        <View className="gap-1 border-b border-border px-4 pb-4 pt-3">
          ...
          <Text className="text-xs font-kairo-bold tracking-[1px] uppercase text-foreground-muted">
            Repository
          </Text>
          <Text className="pr-10 text-xl font-kairo-bold">{currentBranchLabel}</Text>
