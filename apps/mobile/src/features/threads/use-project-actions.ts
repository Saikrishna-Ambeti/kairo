...
import { EnvironmentScopedProjectShell, type VcsRef } from "@kairo/client-runtime";
import {
  CommandId,
...
import { buildTemporaryWorktreeBranchName, sanitizeFeatureBranchName } from "@kairo/shared/git";
