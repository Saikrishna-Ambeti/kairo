...
import { effectiveSnoozed } from "@kairo/client-runtime/state/thread-settled";
      ...
      <GestureHandlerRootView style={{ flex: 1 }}>
        ...
        >
          <View className="flex-row items-center justify-between gap-3 px-5 py-3">
            <Text className="flex-1 text-xl font-kairo-semibold">Arrange threads</Text>
            <Pressable
                ...
                return (
                  ...
                  >
                    {thread ? (
                      ...
                      >
                        <Text className="text-sm font-kairo-semibold text-foreground-muted">
            ...
            {visiblePreview ? (
              ...
              >
                <Text
                  ...
                  className="text-base font-kairo-medium"
                >
