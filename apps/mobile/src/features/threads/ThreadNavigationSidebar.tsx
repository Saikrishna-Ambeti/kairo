...
} from "@kairo/client-runtime/state/thread-search";
import { LegendList } from "@legendapp/list/react-native";
import type { MenuAction } from "@react-native-menu/menu";
import { useAtomValue } from "@effect/atom-react";
import { AsyncResult } from "effect/unstable/reactivity";
import type { EnvironmentId } from "@kairo/contracts";
import { sortPinnedThreadsByOrderKey } from "@kairo/client-runtime/state/thread-sort";
import type { ChangeRequestSettleSource } from "@kairo/client-runtime/state/thread-settled";
      ...
      switch (item.type) {
        ...
        case "v2-show-more":
          return (
            ...
            >
              <Text className="text-xs font-kairo-medium text-foreground-muted">
      ...
      >
        ...
        <View className="h-[50px] flex-row items-end gap-0.5 pr-2 pl-5">
          ...
          <WorkspaceConnectionTitle
            ...
            brand={
              <Text
                className="flex-1 text-[34px] font-kairo-bold text-foreground"
                numberOfLines={1}
              >
                Threads
              </Text>
