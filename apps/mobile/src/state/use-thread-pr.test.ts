import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@kairo/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/kairo/kairo/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "kairo/kairo",
    number: 1,
    url: "https://github.com/kairo/kairo/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/kairo/kairo/pull/2" };
