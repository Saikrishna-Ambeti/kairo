...
import { EnvironmentProject, EnvironmentThreadShell } from "@kairo/client-runtime/state/shell";
import type { AtomCommandResult } from "@kairo/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@kairo/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@kairo/contracts";
import { dedupeRemoteBranchesWithLocalMatches, sanitizeFeatureBranchName } from "@kairo/shared/git";
