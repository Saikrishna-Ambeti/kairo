import type { EnvironmentPresentation, PreparedConnection } from "@kairo/client-runtime/connection";
import { connectionCatalogDisplayUrl } from "@kairo/client-runtime/connection";
