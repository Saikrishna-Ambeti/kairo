...
export function CompactBrandTitle(
  ...
  return (
    <View
      aria-level={1}
      accessibilityLabel="Kairo, Threads"
      accessible
      role="heading"
    ...
    >
      <View className="flex-row items-center">
        ...
        <Text
          ...
          className="-ml-px font-kairo-medium text-[21px] tracking-[-0.5px] text-foreground-muted"
        >
          airo
        </Text>
      </View>
      <View className="rounded-full bg-subtle px-1.5 py-0.5">
        <Text
          allowFontScaling={props.allowFontScaling}
          className="font-kairo-bold text-[9px] tracking-[0.9px] text-foreground-muted uppercase"
        >
          {stageLabel}
        </Text>
      </View>
