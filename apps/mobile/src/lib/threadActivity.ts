...
} from "@kairo/client-runtime/pending-requests";
import { UserInputAttachmentAnswerPayload, isToolLifecycleItemType } from "@kairo/contracts";
import type {
...
import { extractToolActivityPresentation } from "@kairo/client-runtime/work-log/tool-presentation";
import { commandProgramName } from "@kairo/client-runtime/work-log/command-label";

import * as Arr from "effect/Array";
import * as Order from "effect/Order";

export type { PendingApproval, PendingUserInput } from "@kairo/client-runtime/pending-requests";
...
export interface WorkLogEntry {
  ...
  toolTitle?: string;
  toolSurface?: import("@kairo/contracts").ToolActivitySurface;
  toolIcon?: import("@kairo/contracts").ToolActivityIcon;
  toolSource?: import("@kairo/contracts").ToolActivitySource;
...
export type ThreadFeedEntry =
  ...
  | {
      ...
      readonly summaryToolIcon?: "browser" | "kairo" | "pull-request";
