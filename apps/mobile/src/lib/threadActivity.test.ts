...
describe("buildThreadFeed", () => {
  ...
  it.each([
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "kairo", tool: "preview_navigate" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "kairo", tool: "task_status" },
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "mcp__kairo__preview_snapshot",
      item: undefined,
      status: "inProgress",
    ...
    },
    {
      ...
      label: "Call MCP tool",
      title: "Call MCP tool",
      item: { server: "kairo", tool: "preview_click" },
      status: undefined,
  ...
  it("retains Claude MCP metadata behind friendly row and running labels", () => {
    ...
    const toolData = {
      toolName: "mcp__kairo__preview_click",
          ...
          makeActivity({
            ...
            payload: {
              ...
              ...(index < commandCount
                ...
                : {
                    itemType: "mcp_tool_call",
                    data: { item: { server: "kairo", tool: "preview_click" } },
                  }),
            },
          }),
        ),
