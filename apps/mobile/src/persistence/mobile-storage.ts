...
const CONNECTIONS_KEY = "kairo.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "kairo.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "kairo.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "kairo.recent-thread-shortcuts";
...
>()("@kairo/mobile/persistence/MobileStorage") {}
