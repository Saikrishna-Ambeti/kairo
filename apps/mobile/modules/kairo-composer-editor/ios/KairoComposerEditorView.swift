...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "kairo-composer-paste"
...
public final class KairoComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
