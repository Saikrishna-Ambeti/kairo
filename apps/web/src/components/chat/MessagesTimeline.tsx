...
import { parseScopedThreadKey } from "@kairo/client-runtime/environment";
import type { CodexArtifactTemplate } from "@kairo/client-runtime/codex-artifact-templates";
import {
  resolveWorkEntryToolPresentation,
  resolveViewedImageAsset,
  workEntryViewedImagePath,
} from "@kairo/client-runtime/work-log/presentation";
import { resolveWorkGroupScrollAnchor } from "@kairo/client-runtime/work-log/scroll-anchor";
import type { AgentPanelModel } from "@kairo/client-runtime/state/subagentRuntime";
import {
...
import { resolveChatListAnchoredEndSpace } from "@kairo/shared/chatList";
import { toolActivityFaviconUrl } from "@kairo/shared/favicon";
import { formatDuration } from "@kairo/shared/orchestrationTiming";
import { getProjectFaviconCacheKey } from "@kairo/shared/projectFavicon";
...
function WorkEntryIcon({ name, className }: { name: WorkEntryIconName; className: string }) {
  switch (name) {
    ...
    case "kairo":
      return <img alt="" aria-hidden className={className} src="/kairo.svg" />;
    case "check":
...
function QuestionAnswerHistory({
  ...
  answer: import("@kairo/contracts").UserInputAttachmentAnswerPayload;
}) {
  const { activeThreadEnvironmentId } = use(TimelineRowCtx);
