...
import { USAGE_LIMITS_COMMAND } from "@kairo/shared/usageLimits";
import {
  Fragment,
  memo,
  type ComponentProps,
...
} from "@kairo/client-runtime/state/attachments";
import {
...
import type { UnifiedSettings } from "@kairo/contracts/settings";
import {
  type ChatMessage,
  type SessionPhase,
  type Thread,
...
const ComposerFooterModeControls = memo(function ComposerFooterModeControls(props: {
  ...
  const [runtimeOpen, setRuntimeOpen] = useComposerMenuState(props.hidden);
  const [interactionOpen, setInteractionOpen] = useComposerMenuState(props.hidden);
      ...
      <>
        ...
        <Tooltip>
          ...
          >
            ...
            >
              <ComposerControlIcon icon={InteractionModeIcon} size={size} />
          ...
          {composerControlsInStrip ? (
            ...
            >
              <CompactComposerControlsMenu
                interactionMode={interactionMode}
                interactionModes={
                  hiddenRestingBlockIds.includes("mode") ? interactionModes : ["default"]
                }
                runtimeMode={runtimeMode}
                size="xs"
  ...
  useImperativeHandle(
    ...
    () => ({
      ...
      getSendContext: () => ({
        ...
        selectedProviderModels,
        interactionMode,
        interactionModeEnabled: interactionModes.length > 1,
      }),
