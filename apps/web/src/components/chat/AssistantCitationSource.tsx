...
import type { AssistantCitation, MessageId, ScopedThreadRef } from "@kairo/contracts";
...
const COMMENT_HIGHLIGHT_NAME = "kairo-assistant-citation-comment";
...
export function observeAssistantCitationSource({
  ...
  const clear = () => {
    if (highlighted && CSS.highlights.get("kairo-assistant-citation") === highlighted) {
      CSS.highlights.delete("kairo-assistant-citation");
    }
    highlighted = null;
    ownedRange = null;
  ...
  const highlight = () => {
    ...
    if (typeof Highlight !== "undefined" && typeof CSS !== "undefined" && CSS.highlights) {
      ...
      CSS.highlights.set("kairo-assistant-citation", highlighted);
      ownedRange = range;
    ...
    if (!pulseAnimation) {
      ...
      pulseAnimation.id = "kairo-assistant-citation-pulse";
