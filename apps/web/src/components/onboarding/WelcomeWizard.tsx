...
import { CommandId, ProviderDriverKind, ThreadId } from "@kairo/contracts";
...
function ConnectAccountOption({
  ...
  const { openAuthPrompt } = useKairoConnectAuthPrompt();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1">Kairo Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <CommandBlock command="npx kairo connect" className="mt-3" />
          <p className="mt-3 text-xs text-muted-foreground">
            Keep Kairo running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
      ...
      >
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <CommandBlock command="npx kairo pair" className="mt-2" />
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Kairo first, or run <code className="font-mono">npx kairo serve</code>. Add{" "}
