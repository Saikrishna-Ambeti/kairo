...
import {
  ...
  effectiveSnoozed,
  threadWokeAt,
} from "@kairo/client-runtime/state/thread-settled";
import {
...
function ChatViewContent(props: ChatViewProps) {
  ...
  const interactionMode =
    requestedInteractionMode === "study" && settings.professionalRole !== "student"
      ? DEFAULT_INTERACTION_MODE
  ...
  // Keep context selection behavior intact without rendering its strip in chat.
  const showComposerContextStrip = false;
