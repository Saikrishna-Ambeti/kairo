...
import { projectScriptsInheritDefaults, resolveProjectScripts } from "@kairo/shared/projectScripts";
...
function ProjectDetail({
  ...
  const inheritedEnvMode =
    kairoFile.file?.defaultThreadEnvMode ?? scriptSettings.defaultThreadEnvMode;
      ...
      <SettingsPageContainer className="gap-6">
        <SettingsSection title="Project" hideTitle>
          ...
          <SettingsRow
            ...
            description={
              storedEnvMode === null
                ? "Inherited from kairo.json or machine defaults."
