import type { BrowserImportSource } from "@kairo/contracts";
import { BROWSER_IMPORT_FAILURE_COPY } from "@kairo/contracts";
...
function FullDiskAccessStep({
  ...
  return (
    <>
      <DialogHeader>
        <DialogTitle>Let Kairo read {source.name}&rsquo;s cookies</DialogTitle>
        <DialogDescription>
          To import cookies from {source.name}, Kairo needs Full Disk Access. Turn it on in System
      ...
      {stillRequired ? (
        <DialogPanel>
          <p role="status" className="text-sm text-muted-foreground">
            Full Disk Access is still required. If you just turned it on, quit and reopen Kairo,
            then try again.
          </p>
        </DialogPanel>
      ) : null}
