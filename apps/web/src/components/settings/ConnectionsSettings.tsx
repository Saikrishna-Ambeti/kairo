  ...
  return (
    <>
      {window.desktopBridge ? (
        <SettingsRow
          title={searchableSetting("kairo-connect").title}
          description={
            managedTunnelActive
      ...
      <SettingsRow
        ...
        description="Send activity to mobile notifications and Live Activities without Kairo Connect."
        control={
          <CloudLinkSwitch
    ...
    return (
      <>
        ...
        {desktopWslState.enabled ? (
          <SettingsRow
            title="WSL only"
            description="Run only the WSL backend. Kairo restarts when this changes."
