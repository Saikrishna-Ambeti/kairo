...
import { connectionStatusTitle } from "@kairo/client-runtime/connection";
...
} from "@kairo/shared/backgroundActivitySettings";
...
function providerEnvironmentDetail(environment: EnvironmentPresentation): string {
  ...
  if (environment.relayManaged) return "Kairo Connect";
