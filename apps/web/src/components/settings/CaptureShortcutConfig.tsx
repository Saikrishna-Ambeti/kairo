...
import { parseKeybindingShortcut } from "@kairo/shared/keybindings";
    ...
    <div className="space-y-4 text-sm">
      ...
      {result ? (
        ...
        <>
          ...
          {!supported ? (
            <p className="text-xs text-muted-foreground">
              Update Kairo to finish setting up your shortcut.
            </p>
          ) : null}
        </>
      )}
      ...
      {state.shortcutActionRegistered === false && state.shortcutMessage ? (
        <p role="status" className="text-muted-foreground">
          {state.shortcutPending
            ...
            : "Restart Kairo to finish connecting your shortcut."}
        </p>
      ) : null}
      <details className="text-xs text-muted-foreground">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div className="space-y-1">
            ...
            {niri ? <p>Kairo also reads any files included by this file.</p> : null}
