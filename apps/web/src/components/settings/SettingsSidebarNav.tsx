...
const KairoConnectSidebarSignIn = lazy(() =>
  import("../clerk/KairoConnectSidebarSignIn").then((module) => ({
    default: module.KairoConnectSidebarSignIn,
  })),
);
const KairoConnectSidebarAvatar = lazy(() =>
  import("../clerk/KairoConnectSidebarSignIn").then((module) => ({
    default: module.KairoConnectSidebarAvatar,
  })),
);
...
> = {
  ...
  "/settings/memory": BrainCircuitIcon,
