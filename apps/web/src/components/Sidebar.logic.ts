import { threadPullRequestSearchTerms } from "@kairo/shared/threadPullRequests";
...
import type { ContextMenuItem } from "@kairo/contracts";
import type { SidebarProjectSortOrder, SidebarThreadSortOrder } from "@kairo/contracts/settings";
import type { AsyncResult } from "effect/unstable/reactivity";
import { planPinnedReorder } from "@kairo/client-runtime/state/thread-sort";
import {
...
export { sortActiveThreadsByOrderKey as sortThreadsForSidebar } from "@kairo/client-runtime/state/thread-sort";

// Pinned-reorder key math and the keyed sort live in client-runtime
// (state/thread-sort) so web and mobile compute identical pinned orders.
export { pinOrderKeyBetween, planPinnedReorder } from "@kairo/client-runtime/state/thread-sort";
export { sortPinnedThreadsByOrderKey as sortPinnedThreadsForSidebar } from "@kairo/client-runtime/state/thread-sort";
