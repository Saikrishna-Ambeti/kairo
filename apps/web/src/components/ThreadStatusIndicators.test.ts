import { effectiveSettled } from "@kairo/client-runtime/state/thread-settled";
import type { OrchestrationThreadShell } from "@kairo/contracts";
import { ProjectId, ProviderInstanceId, ThreadId, type VcsStatusResult } from "@kairo/contracts";
  ...
  it("after caching a merged PR, resolves main status back to the cached feature PR", () => {
    ...
    const mainStatus = status({
      ...
      pr: {
        ...
        url: "https://github.com/pingdotgg/kairo/pull/99",
        baseRef: "main",
        headRef: "main",
        state: "open",
      },
