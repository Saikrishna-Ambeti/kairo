...
describe("buildThreadActionItems", () => {
  ...
  it("keeps message excerpts searchable without replacing thread metadata", () => {
    const [item] = buildThreadActionItems({
      ...
      projectTitleById: new Map([[PROJECT_ID, "Kairo"]]),
      sortOrder: "updated_at",
      icon: null,
      getContentMatch: () => ({
        source: "assistant",
    ...
    expect(item?.description).toBe("Kairo · #feat/search");
  });
  ...
  it("prefers renderDescription when provided", () => {
    ...
    expect(item?.description).toBe("Kairo:feat/search:wt");
  });
...
it.each([
  "#10839",
  "10839",
  "pingdotgg/kairo#10839",
  "https://github.com/pingdotgg/kairo/pull/10839",
        ...
        pullRequests: [
          {
            ...
            number: 10839,
            url: "https://github.com/pingdotgg/kairo/pull/10839",
            source: "manual",
