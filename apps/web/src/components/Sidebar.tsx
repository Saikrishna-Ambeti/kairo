...
import type { ScopedThreadRef, ThreadId } from "@kairo/contracts";
...
const SETTLED_SHELF_EXPANDED_KEY = "kairo:sidebar-v2:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "kairo:sidebar-v2:snoozed-expanded";
