...
function KairoWordmark() {
  return (
    <span aria-label="Kairo" className="flex shrink-0 items-end gap-0 text-foreground">
      <img alt="" aria-hidden="true" className="size-5 shrink-0" src="/kairo.svg" />
      <span className="text-sm font-semibold tracking-tight h-fit">airo</span>
    </span>
  );
}
