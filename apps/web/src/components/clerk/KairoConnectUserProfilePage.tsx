import { findErrorTraceId } from "@kairo/client-runtime/errors";
import {
...
export function KairoConnectEnvironmentRow(props: {
          ...
          <div className="pt-3">
            ...
            >
              ...
              <p className="mt-4 max-w-xl text-[0.8125rem] leading-[1.125rem] text-muted-foreground">
                Kairo Connect access will be revoked, any managed tunnel will be removed, and a host
...
export function KairoConnectUserProfilePage() {
  ...
  const handleDeregister = async (environment: RelayClientEnvironmentRecord) => {
    ...
    if (result._tag === "Success") {
      ...
      toastManager.add({
        ...
        description: "Kairo Connect access was revoked and a host space is now available.",
      });
      return;
    }
    ...
    console.error("[kairo-connect] Could not deregister environment", {
      environmentId: environment.environmentId,
      message,
      traceId,
      cause,
