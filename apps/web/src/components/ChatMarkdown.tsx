...
import { inlineCodeFilePathCandidate } from "@kairo/client-runtime/markdown-links";
import { mediaFileReference, mediaUrlReference } from "@kairo/client-runtime/media-reference";
import { mediaKindFromPath, mediaMimeTypeFromExtension } from "@kairo/shared/filePreview";
...
import { parseAssistantCitationHref } from "@kairo/shared/assistantCitations";
...
const CHAT_MARKDOWN_SANITIZE_SCHEMA = {
  ...
  protocols: {
    ...
    href: [...(defaultSchema.protocols?.href ?? []), "file", "kairo-citation"],
