 ...
 */
import { scopedThreadKey } from "@kairo/client-runtime/environment";
import type { ChatFileAttachment, ScopedThreadRef } from "@kairo/contracts";
...
const RIGHT_PANEL_STORAGE_KEY = "kairo:right-panel-state:v2";
