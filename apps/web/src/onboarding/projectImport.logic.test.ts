import { EnvironmentId, ProjectId, type AgentSessionProjectCandidate } from "@kairo/contracts";
...
describe("groupOnboardingProjects", () => {
  it("groups clones by origin, keeps local repos separate, and folds non-git folders away", () => {
    const main = candidate("/code/kairo", {
      git: github("pingdotgg/kairo"),
      threadCount: 79,
      lastActiveAt: "2026-08-21T12:00:00.000Z",
    });
    const clone = candidate("/code/clones/kairo-2", {
      git: github("pingdotgg/kairo"),
      threadCount: 13,
    ...
    expect(
      ...
      {
        label: "pingdotgg/kairo",
        paths: ["/code/kairo", "/code/clones/kairo-2"],
        threadCount: 92,
        lastActiveAt: "2026-08-21T12:00:00.000Z",
      },
      {
