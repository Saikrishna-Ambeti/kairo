import { findProjectByPath } from "@kairo/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@kairo/contracts";
