...
describe("uiStateStore pure functions", () => {
  ...
  it("stores the sidebar project scope and resets it to all projects", () => {
    const scoped = setSidebarProjectScopeKey(makeUiState(), "github.com/pingdotgg/kairo");

    expect(scoped.sidebarProjectScopeKey).toBe("github.com/pingdotgg/kairo");
    expect(setSidebarProjectScopeKey(scoped, "github.com/pingdotgg/kairo")).toBe(scoped);
...
describe("uiStateStore persistence", () => {
  ...
  it("restores the sidebar project scope across reloads", () => {
    persistState(makeUiState({ sidebarProjectScopeKey: "github.com/pingdotgg/kairo" }));
