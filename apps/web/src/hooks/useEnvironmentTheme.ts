import type { EnvironmentTheme } from "@kairo/contracts";
...
function publishedThemeColors(
  ...
  // desktop theme arrives as a coherent Kairo palette rather than a foreign
 ...
 * than rendered: a published `kairo-iris.json` would show this palette on its
