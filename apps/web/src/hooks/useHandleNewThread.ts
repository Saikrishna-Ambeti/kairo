...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@kairo/contracts";
...
import { resolveDefaultThreadEnvMode } from "@kairo/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { resolveNewDraftStartFromOrigin } from "../lib/chatThreadActions";
import { readKairoProjectFileDefaultThreadEnvMode } from "../lib/kairoProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The kairo.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readKairoProjectFileDefaultThreadEnvMode(
