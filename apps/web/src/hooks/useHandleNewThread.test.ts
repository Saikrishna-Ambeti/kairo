...
vi.mock("@kairo/client-runtime/environment", () => ({
  scopedProjectKey: () => "remote-project",
  scopeProjectRef: (environmentId: string, projectId: string) => ({ environmentId, projectId }),
  scopeThreadRef: (environmentId: string, threadId: string) => ({ environmentId, threadId }),
}));
vi.mock("@kairo/contracts", () => ({ DEFAULT_RUNTIME_MODE: "default" }));
vi.mock("@kairo/shared/threadEnvMode", () => ({
...
vi.mock("../lib/kairoProjectFileDefaults", () => ({
  readKairoProjectFileDefaultThreadEnvMode: () => testState.projectFileRead,
}));
vi.mock("../lib/utils", () => ({
