...
export const CLIENT_SETTINGS_STORAGE_KEY = "kairo:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "kairo:saved-environment-registry:v1";
