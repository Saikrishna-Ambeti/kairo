...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "pingdotgg/kairo", number: 4909 };
    const second = { projectId: "project-a", repository: "pingdotgg/kairo", number: 4910 };
    useRightPanelStore.getState().openPullRequest(refA, first);
    useRightPanelStore.getState().openPullRequest(refA, second);
    const url = "https://gitlab.example.com/pingdotgg/kairo/-/merge_requests/4909";
