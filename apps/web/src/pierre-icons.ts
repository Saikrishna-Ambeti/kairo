...
import { VIDEO_FILE_EXTENSIONS } from "@kairo/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "kairo-pierre-file-icon-sprite";

const KAIRO_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <!-- Lucide Film icon, ISC license. -->
  <symbol id="kairo-file-icon-video" viewBox="0 0 24 24">
  ...
  <symbol id="kairo-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="kairo-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="kairo-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="kairo-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="kairo-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="kairo-file-icon-pnpm" viewBox="0 0 32 32">
...
export const KAIRO_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: KAIRO_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "kairo-file-icon-package-json",
    "tsconfig.json": "kairo-file-icon-tsconfig",
    "agents.md": "kairo-file-icon-agents",
    "claude.md": "kairo-file-icon-claude",
    "readme.md": "kairo-file-icon-readme",
    "pnpm-lock.yaml": "kairo-file-icon-pnpm",
    "pnpm-workspace.yaml": "kairo-file-icon-pnpm",
  },
  byFileExtension: Object.fromEntries(
    VIDEO_FILE_EXTENSIONS.map((extension) => [extension, "kairo-file-icon-video"]),
  ),
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(KAIRO_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${KAIRO_FILE_ICON_SPRITE}`;
