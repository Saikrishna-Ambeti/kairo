...
import { EnvironmentId, ThreadId, type TerminalSummary } from "@kairo/contracts";
import { selectRunningSubprocessTerminalIds } from "@kairo/client-runtime/state/terminal";
