...
import { pullRequestHostOf, resolveEnvironmentMachineKind, ThreadId } from "@kairo/contracts";
import type {
  EnvironmentId,
  ProjectId,
    ...
    <>
      {!capabilityKnown ? (
        ...
        <PullRequestsUnavailableState
          ...
          error="Update your Kairo servers to browse pull requests."
        />
      ) : firstLoad ? (
        <PullRequestListGhost rows={7} />
      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        {rightPanelPresent && renderedPullRequestSurface && panelEnvironmentId !== null ? (
          <RightPanelTabs
            ...
            widthStorageKey="kairo:pull-request-panel-width"
