...
import type { EnvironmentCloudLinkStateResult, EnvironmentId } from "@kairo/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read Kairo Connect link state.";
  }
