...
} from "@kairo/client-runtime/platform";
import {
...
import { bootstrapRemoteBearerSession } from "@kairo/client-runtime/authorization";
import { fetchRemoteEnvironmentDescriptor } from "@kairo/client-runtime/environment";
import { managedRelayAccountChanges, managedRelaySessionAtom } from "@kairo/client-runtime/relay";
import { EnvironmentRpcRequestObserver } from "@kairo/client-runtime/rpc";
import {
...
function clientMetadata() {
  ...
  return {
    label: desktop ? "Kairo Desktop" : "Kairo Web",
