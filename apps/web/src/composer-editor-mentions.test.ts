import { EnvironmentId, MessageId, ThreadId, type AssistantCitation } from "@kairo/contracts";
import { serializeAssistantCitation } from "@kairo/shared/assistantCitations";
...
describe("splitPromptIntoComposerSegments", () => {
  ...
  it("keeps malformed citation links as editable text", () => {
    const prompt =
      "[Assistant quote](kairo-citation://v1/env/thread/message?text=missing+metadata)";
