...
const ROUTER_HOST = "app.kairo.codes";
const HOSTED_WEB_CHANNEL_COOKIE = "kairo_web_channel";
const LATEST_ORIGIN = "https://latest.app.kairo.codes";
const NIGHTLY_ORIGIN = "https://nightly.app.kairo.codes";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @kairo/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
