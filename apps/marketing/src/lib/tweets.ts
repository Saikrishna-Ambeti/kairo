...
export const tweets = [
  {
    handle: "QuinnyPig",
    content:
      "Of course @theo is gonna favor his own product.\n\nBut I don’t have a horse in this race, so believe me when I say Kairo code is freaking transformational.",
    excerpt:
      "...I don’t have a horse in this race, so believe me when I say Kairo code is freaking transformational.",
    link: "https://x.com/QuinnyPig/status/2089581739887014376",
  },
  {
    handle: "tannerlinsley",
    content: "I would just use Kairo at that point and contribute back.",
    link: "https://x.com/tannerlinsley/status/2035067912659341399",
  },
  {
    handle: "ryanrhughes",
    content:
      "I think I've finally found the one AI harness to steal me away from the terminal — @kairodotcodes.",
  ...
  },
  {
    ...
    content:
      "Well I was 2,000 miles away on holiday and able to do iOS development from just my phone, Kairo’s remote feature is a magical experience",
  ...
  },
  {
    handle: "aronprins",
    content:
      "Kairo works better than Claude and Codex combined… and Kairo actually combines then (and more!) 🤯\n\nHuge shoutout to @theo and @jullerino\n\nAmazing product fellers 🔥🙌",
    excerpt:
      "Kairo works better than Claude and Codex combined… and Kairo actually combines then (and more!)",
  ...
  },
  {
    handle: "ryanrhughes",
    content:
      "Then there's the mobile app. All of my threads, on all of my environments, in my pocket. Fantastic.\n\nWhile traveling the other day, I had to use Kairo alongside my old Claude Code + Herdr setup from 36,000ft on my phone.\n\nOn Kairo, it felt like LAN. On the TUI, every keystroke took about 1sec to show up because it had to roundtrip to the device before I was able to actually see it. Brutal.",
    excerpt: "...from 36,000ft on my phone. On Kairo, it felt like LAN.",
    link: "https://x.com/ryanrhughes/status/2093051708939059204",
  },
  {
    handle: "ex0t1clol",
    content: "Kairo is proof electron apps don't have to suck",
    link: "https://x.com/ex0t1clol/status/2054666870008021197",
  },
  {
    handle: "enunomaduro",
    content: "So I tried @theo's Kairo...",
  ...
  },
  {
    handle: "leodev",
    content:
      "Kairo is probably the first coding gui that didn't suck performance wise and had a smart team behind it.",
  ...
  {
    handle: "iamkaffe",
    content: "Kairo was the first one to truly care about Linux users.",
    link: "https://x.com/iamkaffe/status/2054675539311411280",
  },
  {
    handle: "_winter_wonders",
    content: "Heartbreaking: AI-hater has to admit Kairo is really good.",
