...
import { SourceControlProviderError, type ChangeRequest } from "@kairo/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set KAIRO_BITBUCKET_EMAIL and KAIRO_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request, repository, and user read scopes).",
