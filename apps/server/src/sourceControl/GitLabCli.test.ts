...
import { VcsProcessExitError } from "@kairo/contracts";
        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              source_project: {
                path_with_namespace: "octocat/kairo",
              },
            }),
          ),
        ),
  ...
  it.effect("reads repository clone URLs", () =>
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/kairo",
              web_url: "https://gitlab.com/octocat/kairo",
              http_url_to_repo: "https://gitlab.com/octocat/kairo.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/kairo.git",
            }),
          ),
        ),
      );
      ...
      assert.deepStrictEqual(result, {
        ...
        url: "https://gitlab.com/octocat/kairo",
        sshUrl: "git@gitlab.com:octocat/kairo.git",
      });
    }),
  );
      ...
      expect(mockedRun).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          args: [
            ...
            "title=Provider MR",
            "--field",
            "description=@/tmp/kairo-mr-body.md",
          ],
        }),
      );
    }),
