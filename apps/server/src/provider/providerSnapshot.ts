...
import { normalizeCustomModelSlug } from "@kairo/shared/model";
...
export function buildServerProvider(input: {
  ...
  return {
    ...
    ...(typeof input.presentation.showInteractionModeToggle === "boolean"
      ...
      : {}),
    ...(input.presentation.supportedInteractionModes
      ? { supportedInteractionModes: [...input.presentation.supportedInteractionModes] }
      : {}),
