import { type GrokSettings, ProviderDriverKind, type RuntimeMode } from "@kairo/contracts";
...
import { normalizeModelSlug } from "@kairo/shared/model";
...
const KAIRO_OAUTH_REFERRER = "kairo";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: KAIRO_OAUTH_REFERRER,
    },
  };
}
...
/**
 * Kairo's built-in Grok slug. It is the CLI's product name, not a model id the ACP accepts,
