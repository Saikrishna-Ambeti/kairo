import { type GrokSettings, ProviderDriverKind } from "@kairo/contracts";
...
const Kairo_CODE_OAUTH_REFERRER = "kairo";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: Kairo_CODE_OAUTH_REFERRER,
    },
  };
}
