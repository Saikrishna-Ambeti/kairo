...
describe("Antigravity process environment", () => {
  const profile: AntigravityProfile = {
    platform: "linux",
    geminiHome: "/kairo/userdata/providers/antigravity/profile",
    acpDirectory: "/kairo/userdata/providers/antigravity/profile/antigravity-acp",
    tokenPath: "/kairo/userdata/providers/antigravity/profile/antigravity-acp/acp_token.json",
