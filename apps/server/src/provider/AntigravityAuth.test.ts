...
import { ProviderInstanceId, ProviderSetupError, type ProviderAuthState } from "@kairo/contracts";
...
const owner = "kairo-auth-session-owner";
const otherOwner = "kairo-auth-session-other";
