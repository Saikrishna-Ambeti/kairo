          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  KAIRO_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.kairo-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.kairo-code.bearer_token_env_var="KAIRO_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
