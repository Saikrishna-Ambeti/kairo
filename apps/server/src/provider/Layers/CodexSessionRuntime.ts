...
import { buildComposioCodexArgs } from "../../composio/ComposioMcp.ts";
...
export interface CodexSessionRuntimeOptions {
  ...
  /**
   * Whether the attached `kairo-code` MCP server exposes the preview tools. The
...
/** Converts a Kairo approval decision into the MCP elicitation wire response. */
