...
import { parseCliArgs } from "@kairo/shared/cliArgs";
...
} from "@kairo/shared/claudeCompaction";
...
export const makeClaudeAdapter = Effect.fn("makeClaudeAdapter")(function* (
  ...
  const handleSystemMessage = Effect.fn("handleSystemMessage")(function* (
    ...
    switch (message.subtype) {
      ...
      case "model_refusal_fallback":
        ...
        return;
      // Inner protocol/UX details with no Kairo surface today — consumed
  ...
  const handleSdkMessage = Effect.fn("handleSdkMessage")(function* (
    ...
    // Wire-only command bookkeeping has no user-facing Kairo lifecycle.
    ...
    switch (message.type) {
      ...
      case "rate_limit_event":
        ...
        return;
      // Composer prompt suggestions have no Kairo surface; consumed deliberately.
      // `conversation_reset` announces a CLI-side conversation id swap
      // (e.g. /clear); Kairo keeps its own thread identity and resume cursor.
  ...
  const startSession: ClaudeAdapterShape["startSession"] = Effect.fn("startSession")(
    function* (input) {
      ...
      const handleAskUserQuestion = Effect.fn("handleAskUserQuestion")(function* (
        ...
        // expected lookup key. See https://github.com/Saikrishna-Ambeti/kairo/issues/2388
      ...
      const handleResumeDialog = Effect.fn("handleResumeDialog")(function* (
        ...
        // The question copy lives in @kairo/shared/claudeCompaction because
