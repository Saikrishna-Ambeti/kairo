 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@kairo/contracts";
...
>()("kairo/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
