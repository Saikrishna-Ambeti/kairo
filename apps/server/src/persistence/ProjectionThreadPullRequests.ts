import { normalizeThreadPullRequestKey } from "@kairo/shared/threadPullRequests";
import {
  IsoDateTime,
  PositiveInt,
  ThreadId,
...
>()("kairo/persistence/ProjectionThreadPullRequests/ProjectionThreadPullRequestRepository") {}
