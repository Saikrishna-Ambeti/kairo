...
import { makeKeyedCoalescingWorker } from "@kairo/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@kairo/shared/hostProcess";
import { getTerminalLabel } from "@kairo/shared/terminalLabels";
...
>()("kairo/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("KAIRO_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_Kairo-XXXX/usr/bin, the bundled glib schemas,
