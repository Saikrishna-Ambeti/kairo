...
import { isDevProxiedPath } from "@kairo/shared/devProxy";
import { decodeOtlpTraceRecords } from "@kairo/shared/observability";
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // KAIRO_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
