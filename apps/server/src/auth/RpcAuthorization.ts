...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverListArtifacts]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.scheduledTasksGetSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.scheduledTasksDispatch]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledTasksFireExternal]: AuthOrchestrationOperateScope,
