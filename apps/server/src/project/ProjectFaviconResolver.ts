...
>()("kairo/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* KairoProjectFileLoader.KairoProjectFileLoader;
  ...
  const resolvePathUncached = Effect.fn("ProjectFaviconResolver.resolvePathUncached")(function* (
    ...
    // A kairo.json iconPath takes precedence over the well-known locations.
