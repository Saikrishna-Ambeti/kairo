...
import { type OrchestrationProject, ProjectId } from "@kairo/contracts";
  ...
  it.effect("runs the inherited machine setup action in the checkout's worktree", () => {
    ...
    return Effect.gen(function* () {
      ...
      expect(open).toHaveBeenCalledWith({
        ...
        cwd: "/repo/worktrees/a",
        worktreePath: "/repo/worktrees/a",
        env: { KAIRO_PROJECT_ROOT: "/repo/project", KAIRO_WORKTREE_PATH: "/repo/worktrees/a" },
      });
      ...
      return Effect.gen(function* () {
        ...
        expect(open).toHaveBeenCalledWith({
          ...
          env: {
            ...
            KAIRO_WORKTREE_PATH: "/repo/worktrees/a",
          },
        });
        expect(write).toHaveBeenCalledWith({
          threadId: "thread-1",
