import type { ServerSelfUpdateOutcome } from "@kairo/contracts";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different kairo version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "kairo/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("kairo/cloud/serviceLauncherClient") {}
