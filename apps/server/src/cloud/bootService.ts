...
// (com.kairo.app), so launchd and TCC records never collide.
export const BOOT_SERVICE_LAUNCHD_LABEL = "com.kairo.app.service";
export const BOOT_SERVICE_PLIST_FILE = `${BOOT_SERVICE_LAUNCHD_LABEL}.plist`;
export const BOOT_SERVICE_UNIT_ENV = "KAIRO_BOOT_SERVICE_UNIT";
