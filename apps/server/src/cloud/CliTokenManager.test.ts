import { readConnectAuthorizeRequest } from "@kairo/shared/connectAuth";
...
const TEST_ENV = {
  KAIRO_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  KAIRO_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  KAIRO_HOSTED_APP_URL: "https://hosted.example.test",
};
