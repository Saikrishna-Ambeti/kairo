...
} from "@kairo/shared/connectAuth";
import { clerkFrontendApiUrlFromPublishableKey } from "@kairo/shared/relayAuth";
...
declare const __KAIRO_BUILD_RELAY_URL__: string | undefined;
declare const __KAIRO_BUILD_CLERK_PUBLISHABLE_KEY__: string | undefined;
declare const __KAIRO_BUILD_CLERK_CLI_OAUTH_CLIENT_ID__: string | undefined;
declare const __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_URL__: string | undefined;
declare const __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_DATASET__: string | undefined;
declare const __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_TOKEN__: string | undefined;
...
export const buildTimeRelayUrl =
  typeof __KAIRO_BUILD_RELAY_URL__ === "undefined"
    ? ""
    : (normalizeSecureRelayUrl(__KAIRO_BUILD_RELAY_URL__) ?? "");
export const buildTimeClerkPublishableKey = readBuildTimeValue(
  typeof __KAIRO_BUILD_CLERK_PUBLISHABLE_KEY__ === "undefined"
    ? undefined
    : __KAIRO_BUILD_CLERK_PUBLISHABLE_KEY__,
);
export const buildTimeClerkCliOAuthClientId = readBuildTimeValue(
  typeof __KAIRO_BUILD_CLERK_CLI_OAUTH_CLIENT_ID__ === "undefined"
    ? undefined
    : __KAIRO_BUILD_CLERK_CLI_OAUTH_CLIENT_ID__,
);
export const buildTimeRelayClientTracing = {
  tracesUrl: readBuildTimeValue(
    typeof __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_URL__ === "undefined"
      ? undefined
      : __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_URL__,
  ),
  tracesDataset: readBuildTimeValue(
    typeof __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_DATASET__ === "undefined"
      ? undefined
      : __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_DATASET__,
  ),
  tracesToken: readBuildTimeValue(
    typeof __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_TOKEN__ === "undefined"
      ? undefined
      : __KAIRO_BUILD_RELAY_CLIENT_OTLP_TRACES_TOKEN__,
  ),
} as const;
...
export function resolveRelayClientTracingConfig(
  ...
  const tracesUrl = env.KAIRO_RELAY_CLIENT_OTLP_TRACES_URL?.trim() || fallback.tracesUrl;
  const tracesDataset =
    env.KAIRO_RELAY_CLIENT_OTLP_TRACES_DATASET?.trim() || fallback.tracesDataset;
  const tracesToken = env.KAIRO_RELAY_CLIENT_OTLP_TRACES_TOKEN?.trim() || fallback.tracesToken;
...
export function makeRelayUrlConfig(fallback = buildTimeRelayUrl) {
  const runtimeConfig = Config.nonEmptyString("KAIRO_RELAY_URL");
...
export function makeCloudCliOAuthConfig({
  ...
  return Config.all({
    ...
    clientId: makePublicValueConfig(
      "KAIRO_CLERK_CLI_OAUTH_CLIENT_ID",
