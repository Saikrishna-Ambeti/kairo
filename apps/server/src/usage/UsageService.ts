 ...
 *
 * The scan reads the provider CLIs' own session files rather than Kairo's
 * orchestration projections, so usage covers turns driven outside Kairo too.
