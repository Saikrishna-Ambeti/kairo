  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const commitEnv: NodeJS.ProcessEnv = {
        ...
        GIT_AUTHOR_NAME: "Kairo",
        GIT_AUTHOR_EMAIL: "kairo@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Kairo",
        GIT_COMMITTER_EMAIL: "kairo@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `kairo checkpoint ref=${input.checkpointRef}`;
