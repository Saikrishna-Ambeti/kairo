...
import { type ClientOrchestrationCommand, CommandId, MessageId, ThreadId } from "@kairo/contracts";
...
const testLayer = Layer.mergeAll(
  ...
  ServerConfig.layerTest(process.cwd(), { prefix: "kairo-normalizer-attachments-" }),
