...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-cursor-batch-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-import-shell-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-branch-pr-projection-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-base-")))(
...
it.layer(Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-pull-requests-")))(
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-attachments-overwrite-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-attachments-rollback-")),
)("OrchestrationProjectionPipeline", (it) => {
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-revert-files/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-revert-files/turn/2"),
          status: "ready",
          files: [],
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-attachments-revert-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-attachments-delete-")),
)("OrchestrationProjectionPipeline", (it) => {
...
it.layer(
  Layer.fresh(makeProjectionPipelinePrefixedTestLayer("kairo-projection-attachments-replay-")),
)("OrchestrationProjectionPipeline", (it) => {
      ...
      Effect.gen(function* () {
        ...
        yield* appendAndProject({
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-completed"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-conflict/turn/1"),
            status: "ready",
            files: [],
      ...
      const refreshEvents = [
        ...
        },
        {
          ...
          payload: {
            ...
            turnId: TurnId.make("turn-shell-summary-1"),
            checkpointTurnCount: 1,
            checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-shell-summary/1"),
            status: "ready",
            files: [],
    ...
    Effect.gen(function* () {
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 1,
          checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-revert/turn/1"),
          status: "ready",
          files: [],
      ...
      yield* appendAndProject({
        ...
        payload: {
          ...
          checkpointTurnCount: 2,
          checkpointRef: CheckpointRef.make("refs/kairo/checkpoints/thread-revert/turn/2"),
          status: "ready",
          files: [],
...
it.layer(makeProjectionPipelinePrefixedTestLayer("kairo-pending-turn-terminal-test-"))(
    ...
    Effect.provide(
      Layer.provideMerge(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "kairo-projection-pipeline-restart-",
        }),
        NodeServices.layer,
      ),
    ),
...
const engineLayer = it.layer(
  OrchestrationEngineLive.pipe(
    ...
    Layer.provideMerge(
      ServerConfig.layerTest(process.cwd(), {
        prefix: "kairo-projection-pipeline-engine-dispatch-",
      }),
    ),
    Layer.provideMerge(NodeServices.layer),
  ),
