...
const guardedMobileFile = createOxlintRuleHarness("kairo/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "kairo/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("kairo/no-mobile-uniwind-theme-escape-hatches", () => {
