...
const rule = createOxlintRuleHarness("kairo/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("kairo/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("kairo/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("kairo/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("kairo/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
