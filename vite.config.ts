...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-kairo/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    overrides: [
      {
        ...
        rules: { "kairo/no-global-process-runtime": "off" },
      },
      {
        files: ["apps/mobile/src/**"],
        rules: { "kairo/no-mobile-uniwind-theme-escape-hatches": "error" },
      },
      {
        ...
        files: [
          ...
          "apps/mobile/src/native/KairoComposerEditor.ios.tsx",
          "apps/mobile/src/native/KairoComposerEditor.native.tsx",
        ],
        rules: {
          "kairo/no-mobile-uniwind-theme-escape-hatches": ["error", { allowUniwindTheme: true }],
        },
      },
      ...
      ...Object.entries({
        ...
        return { files: [file], rules: { "kairo/no-manual-effect-runtime-in-tests": rule } };
      }),
    ],
    options: {
