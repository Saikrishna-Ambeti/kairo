import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@kairo/contracts";
...
}>("@kairo/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentStreamCommandRpcTag =
  ...
  | typeof WS_METHODS.serverInstallAndLoginComposio
  | typeof WS_METHODS.serverLoginComposio
  | typeof WS_METHODS.serverLinkComposioToolkit;
...
}>("@kairo/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
