...
import { RelayManagedEndpoint } from "@kairo/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@kairo/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@kairo/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
