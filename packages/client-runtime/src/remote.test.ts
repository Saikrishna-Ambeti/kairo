  ...
  it.effect("fails hung fetch requests on the configured timeout", () =>
    Effect.gen(function* () {
      ...
      expect(error.message).toBe(
        "Remote auth endpoint http://remote.example.com/.well-known/kairo/environment timed out after 25ms.",
      );
