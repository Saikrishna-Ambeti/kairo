...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/kairo/OpenInPicker.tsx#L69",
      "D:/Programme/kairo/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/kairo/OpenInPicker.tsx", "D:/Programme/kairo/OpenInPicker.tsx"],
    ["</D:/Programme/kairo/ChatMarkdown.tsx:1>", "D:/Programme/kairo/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\kairo\\apps\\web\\a.ts", "C:/Users/mike/kairo", "apps/web/a.ts"],
    ["/C:/Users/mike/kairo/apps/web/a.ts", "C:/Users/mike/kairo", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/kairo/main.ts", "c:/users/MIKE/kairo", "main.ts"],
    ["/C:/USERS/mike/kairo/main.ts", "/c:/users/MIKE/kairo", "main.ts"],
