...
const LIST_RESULT: PullRequestListResult = {
  ...
  entries: [
    {
      ...
      url: "https://github.com/pingdotgg/kairo/pull/1",
  ...
  errors: [],
  truncated: false,
  nextCursors: { "github.com pingdotgg/kairo": "2026-07-02T00:00:00Z|1|1" },
};
...
describe("PullRequestListInput", () => {
  ...
  it("takes back the continuation a result handed out, keyed the way it arrived", () => {
    const cursors = { "github.com pingdotgg/kairo": "2026-07-02T00:00:00Z|99|1,2" };
