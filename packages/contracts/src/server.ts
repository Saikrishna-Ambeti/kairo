...
/**
 * A palette the environment's machine publishes for Kairo to follow, read
 ...
 * over as a coherent Kairo palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `kairo` package to install (never a dist-tag, so
