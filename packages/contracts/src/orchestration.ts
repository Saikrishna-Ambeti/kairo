...
export const ProviderInteractionMode = Schema.Literals(["default", "plan", "study"]);
...
export const OrchestrationProject = Schema.Struct({
  ...
  // "no override": clients fall back to kairo.json, then the global setting.
 ...
 * request (see `@kairo/shared/threadPullRequests`) so clients from before
