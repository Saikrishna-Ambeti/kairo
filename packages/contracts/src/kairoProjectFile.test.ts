...
import { KairoProjectFile } from "./kairoProjectFile.ts";

const decode = Schema.decodeUnknownSync(KairoProjectFile);

describe("KairoProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://kairo.codes/schema/kairo.json",
