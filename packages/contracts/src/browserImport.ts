 ...
 * machine into a Kairo browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Kairo profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Kairo Full Disk Access in System Settings → Privacy & Security, then retry.",
