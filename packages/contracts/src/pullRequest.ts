...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set KAIRO_BITBUCKET_EMAIL and KAIRO_BITBUCKET_API_TOKEN, or KAIRO_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check KAIRO_BITBUCKET_EMAIL and KAIRO_BITBUCKET_API_TOKEN.",
  },
};
