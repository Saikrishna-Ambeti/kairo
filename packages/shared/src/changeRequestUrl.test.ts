...
describe("parseChangeRequestUrl", () => {
  ...
  it("reads a GitLab merge request on any host, nested groups and all", () => {
    ...
    ).toEqual({ host: "gitlab.com", repository: "kairo/platform/kairo", number: 42 });
  ...
  it("reads Bitbucket and both Azure DevOps URL forms", () => {
    ...
    ).toEqual({ host: "dev.azure.com", repository: "acme/platform/_git/kairo", number: 17 });
    expect(
      parseChangeRequestUrl("https://acme.visualstudio.com/platform/_git/kairo/pullrequest/17"),
    ).toEqual({ host: "acme.visualstudio.com", repository: "platform/_git/kairo", number: 17 });
  });
