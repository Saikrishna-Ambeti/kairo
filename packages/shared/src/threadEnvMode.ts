import type { ThreadEnvMode } from "@kairo/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in kairo.json > global server setting.
 *
 ...
 * source that outranks kairo.json decided, or the file read settled. While
