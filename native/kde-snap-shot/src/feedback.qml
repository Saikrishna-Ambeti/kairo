...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for Kairo.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/kairo/KdeCapture/Feedback"
        dbusInterface: "com.kairo.KdeCapture.Feedback"
        method: "Next"
